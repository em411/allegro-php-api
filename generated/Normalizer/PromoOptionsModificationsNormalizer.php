...
class PromoOptionsModificationsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    use CheckArray;
    ...
    {
        return \Em411\Allegro\Api\Model\PromoOptionsModifications::class === $type;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return \is_object($data) && \Em411\Allegro\Api\Model\PromoOptionsModifications::class === \get_class($data);
    }
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Em411\Allegro\Api\Model\PromoOptionsModifications();
        ...
        if (\array_key_exists('modifications', $data) && null !== $data['modifications']) {
            ...
            foreach ($data['modifications'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, \Em411\Allegro\Api\Model\PromoOptionsModification::class, 'json', $context);
            }
            $object->setModifications($values);
            unset($data['modifications']);
        ...
        if (\array_key_exists('additionalMarketplaces', $data) && null !== $data['additionalMarketplaces']) {
            ...
            foreach ($data['additionalMarketplaces'] as $value_1) {
                $values_1[] = $this->denormalizer->denormalize($value_1, \Em411\Allegro\Api\Model\AdditionalMarketplacePromoOptionsModification::class, 'json', $context);
            }
    ...
    {
        return [\Em411\Allegro\Api\Model\PromoOptionsModifications::class => false];
    }
}

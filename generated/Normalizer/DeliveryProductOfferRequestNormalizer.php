...
class DeliveryProductOfferRequestNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    use CheckArray;
    ...
    {
        return \Em411\Allegro\Api\Model\DeliveryProductOfferRequest::class === $type;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return \is_object($data) && \Em411\Allegro\Api\Model\DeliveryProductOfferRequest::class === \get_class($data);
    }
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Em411\Allegro\Api\Model\DeliveryProductOfferRequest();
        ...
        if (\array_key_exists('shippingRates', $data) && null !== $data['shippingRates']) {
            $object->setShippingRates($this->denormalizer->denormalize($data['shippingRates'], \Em411\Allegro\Api\Model\DeliveryProductOfferRequestShippingRates::class, 'json', $context));
    ...
    {
        return [\Em411\Allegro\Api\Model\DeliveryProductOfferRequest::class => false];
    }
}

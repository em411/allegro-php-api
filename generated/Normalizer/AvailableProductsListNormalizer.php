...
class AvailableProductsListNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    use CheckArray;
    ...
    {
        return \Em411\Allegro\Api\Model\AvailableProductsList::class === $type;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return \is_object($data) && \Em411\Allegro\Api\Model\AvailableProductsList::class === \get_class($data);
    }
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Em411\Allegro\Api\Model\AvailableProductsList();
        ...
        if (\array_key_exists('products', $data) && null !== $data['products']) {
            ...
            foreach ($data['products'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, \Em411\Allegro\Api\Model\AvailableProductResponse::class, 'json', $context);
            }
    ...
    {
        return [\Em411\Allegro\Api\Model\AvailableProductsList::class => false];
    }
}

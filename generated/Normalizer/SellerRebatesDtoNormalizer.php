...
class SellerRebatesDtoNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    use CheckArray;
    ...
    {
        return \Em411\Allegro\Api\Model\SellerRebatesDto::class === $type;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return \is_object($data) && \Em411\Allegro\Api\Model\SellerRebatesDto::class === \get_class($data);
    }
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Em411\Allegro\Api\Model\SellerRebatesDto();
        ...
        if (\array_key_exists('promotions', $data) && null !== $data['promotions']) {
            ...
            foreach ($data['promotions'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, \Em411\Allegro\Api\Model\SellerRebateDto::class, 'json', $context);
            }
    ...
    {
        return [\Em411\Allegro\Api\Model\SellerRebatesDto::class => false];
    }
}

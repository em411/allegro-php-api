...
class PostPurchaseIssueFirstMessageNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    use CheckArray;
    ...
    {
        return \Em411\Allegro\Api\Model\PostPurchaseIssueFirstMessage::class === $type;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return \is_object($data) && \Em411\Allegro\Api\Model\PostPurchaseIssueFirstMessage::class === \get_class($data);
    }
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Em411\Allegro\Api\Model\PostPurchaseIssueFirstMessage();
        ...
        if (\array_key_exists('author', $data) && null !== $data['author']) {
            $object->setAuthor($this->denormalizer->denormalize($data['author'], \Em411\Allegro\Api\Model\PostPurchaseIssueAuthor::class, 'json', $context));
            unset($data['author']);
    ...
    {
        return [\Em411\Allegro\Api\Model\PostPurchaseIssueFirstMessage::class => false];
    }
}

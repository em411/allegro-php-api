...
class SaleProductOfferPatchRequestV1productSetItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    use CheckArray;
    ...
    {
        return \Em411\Allegro\Api\Model\SaleProductOfferPatchRequestV1productSetItem::class === $type;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return \is_object($data) && \Em411\Allegro\Api\Model\SaleProductOfferPatchRequestV1productSetItem::class === \get_class($data);
    }
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Em411\Allegro\Api\Model\SaleProductOfferPatchRequestV1productSetItem();
        ...
        if (\array_key_exists('responsiblePerson', $data) && null !== $data['responsiblePerson']) {
            $object->setResponsiblePerson($this->denormalizer->denormalize($data['responsiblePerson'], \Em411\Allegro\Api\Model\ProductSetElementResponsiblePersonRequestResponsiblePerson::class, 'json', $context));
        ...
        if (\array_key_exists('responsibleProducer', $data) && null !== $data['responsibleProducer']) {
            $object->setResponsibleProducer($this->denormalizer->denormalize($data['responsibleProducer'], \Em411\Allegro\Api\Model\ProductSetElementResponsibleProducerRequest::class, 'json', $context));
    ...
    {
        return [\Em411\Allegro\Api\Model\SaleProductOfferPatchRequestV1productSetItem::class => false];
    }
}

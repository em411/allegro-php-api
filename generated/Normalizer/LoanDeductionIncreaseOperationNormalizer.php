...
class LoanDeductionIncreaseOperationNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    use CheckArray;
    ...
    {
        return \Em411\Allegro\Api\Model\LoanDeductionIncreaseOperation::class === $type;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return \is_object($data) && \Em411\Allegro\Api\Model\LoanDeductionIncreaseOperation::class === \get_class($data);
    }
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Em411\Allegro\Api\Model\LoanDeductionIncreaseOperation();
    ...
    {
        return [\Em411\Allegro\Api\Model\LoanDeductionIncreaseOperation::class => false];
    }
}

...
class AlleDiscountSubmitCommandRequestInputNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return \Em411\Allegro\Api\Model\AlleDiscountSubmitCommandRequestInput::class === $type;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return \is_object($data) && \Em411\Allegro\Api\Model\AlleDiscountSubmitCommandRequestInput::class === \get_class($data);
    }
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Em411\Allegro\Api\Model\AlleDiscountSubmitCommandRequestInput();
        if (null === $data || false === \is_array($data)) {
            return $object;
        }
        if (\array_key_exists('offer', $data) && null !== $data['offer']) {
            $object->setOffer($this->denormalizer->denormalize($data['offer'], \Em411\Allegro\Api\Model\AlleDiscountSubmitCommandRequestInputOffer::class, 'json', $context));
            unset($data['offer']);
        ...
        if (\array_key_exists('campaign', $data) && null !== $data['campaign']) {
            $object->setCampaign($this->denormalizer->denormalize($data['campaign'], \Em411\Allegro\Api\Model\AlleDiscountSubmitCommandRequestInputCampaign::class, 'json', $context));
            unset($data['campaign']);
        ...
        if (\array_key_exists('proposedPrice', $data) && null !== $data['proposedPrice']) {
            $object->setProposedPrice($this->denormalizer->denormalize($data['proposedPrice'], \Em411\Allegro\Api\Model\AlleDiscountSubmitCommandRequestInputProposedPrice::class, 'json', $context));
    ...
    {
        return [\Em411\Allegro\Api\Model\AlleDiscountSubmitCommandRequestInput::class => false];
    }
}

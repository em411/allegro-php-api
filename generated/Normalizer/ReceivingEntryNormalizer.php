...
class ReceivingEntryNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return \Em411\Allegro\Api\Model\ReceivingEntry::class === $type;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return \is_object($data) && \Em411\Allegro\Api\Model\ReceivingEntry::class === \get_class($data);
    }
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Em411\Allegro\Api\Model\ReceivingEntry();
        ...
        if (\array_key_exists('received', $data) && null !== $data['received']) {
            ...
            foreach ($data['received'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, \Em411\Allegro\Api\Model\ReceivingStatus::class, 'json', $context);
            }
    ...
    {
        return [\Em411\Allegro\Api\Model\ReceivingEntry::class => false];
    }
}

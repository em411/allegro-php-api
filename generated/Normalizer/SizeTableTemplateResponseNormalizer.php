...
class SizeTableTemplateResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return \Em411\Allegro\Api\Model\SizeTableTemplateResponse::class === $type;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return \is_object($data) && \Em411\Allegro\Api\Model\SizeTableTemplateResponse::class === \get_class($data);
    }
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Em411\Allegro\Api\Model\SizeTableTemplateResponse();
        ...
        if (\array_key_exists('image', $data) && null !== $data['image']) {
            $object->setImage($this->denormalizer->denormalize($data['image'], \Em411\Allegro\Api\Model\SizeTableTemplateImageResponse::class, 'json', $context));
            unset($data['image']);
    ...
    {
        return [\Em411\Allegro\Api\Model\SizeTableTemplateResponse::class => false];
    }
}

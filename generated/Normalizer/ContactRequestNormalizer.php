...
class ContactRequestNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return \Em411\Allegro\Api\Model\ContactRequest::class === $type;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return \is_object($data) && \Em411\Allegro\Api\Model\ContactRequest::class === \get_class($data);
    }
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Em411\Allegro\Api\Model\ContactRequest();
        ...
        if (\array_key_exists('emails', $data) && null !== $data['emails']) {
            ...
            foreach ($data['emails'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, \Em411\Allegro\Api\Model\EmailRequest::class, 'json', $context);
            }
        ...
        if (\array_key_exists('phones', $data) && null !== $data['phones']) {
            ...
            foreach ($data['phones'] as $value_1) {
                $values_1[] = $this->denormalizer->denormalize($value_1, \Em411\Allegro\Api\Model\PhonesRequest::class, 'json', $context);
            }
    ...
    {
        return [\Em411\Allegro\Api\Model\ContactRequest::class => false];
    }
}

...
class NewMessageInThreadNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return \Em411\Allegro\Api\Model\NewMessageInThread::class === $type;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return \is_object($data) && \Em411\Allegro\Api\Model\NewMessageInThread::class === \get_class($data);
    }
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Em411\Allegro\Api\Model\NewMessageInThread();
        ...
        if (\array_key_exists('attachments', $data) && null !== $data['attachments']) {
            ...
            foreach ($data['attachments'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, \Em411\Allegro\Api\Model\MessageAttachmentId::class, 'json', $context);
            }
    ...
    {
        return [\Em411\Allegro\Api\Model\NewMessageInThread::class => false];
    }
}

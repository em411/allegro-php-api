...
class SaleProductOfferResponseV1productSetItemproductNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    use CheckArray;
    ...
    {
        return \Em411\Allegro\Api\Model\SaleProductOfferResponseV1productSetItemproduct::class === $type;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return \is_object($data) && \Em411\Allegro\Api\Model\SaleProductOfferResponseV1productSetItemproduct::class === \get_class($data);
    }
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Em411\Allegro\Api\Model\SaleProductOfferResponseV1productSetItemproduct();
        ...
        if (\array_key_exists('publication', $data) && null !== $data['publication']) {
            $object->setPublication($this->denormalizer->denormalize($data['publication'], \Em411\Allegro\Api\Model\ProductOfferResponsePublication::class, 'json', $context));
        ...
        if (\array_key_exists('parameters', $data) && null !== $data['parameters']) {
            ...
            foreach ($data['parameters'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, \Em411\Allegro\Api\Model\ParameterProductOfferResponse::class, 'json', $context);
            }
    ...
    {
        return [\Em411\Allegro\Api\Model\SaleProductOfferResponseV1productSetItemproduct::class => false];
    }
}

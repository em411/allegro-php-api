...
class ClassifiedsPackagesNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    use CheckArray;
    ...
    {
        return \Em411\Allegro\Api\Model\ClassifiedsPackages::class === $type;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return \is_object($data) && \Em411\Allegro\Api\Model\ClassifiedsPackages::class === \get_class($data);
    }
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Em411\Allegro\Api\Model\ClassifiedsPackages();
        if (null === $data || false === \is_array($data)) {
            return $object;
        }
        if (\array_key_exists('basePackage', $data) && null !== $data['basePackage']) {
            $object->setBasePackage($this->denormalizer->denormalize($data['basePackage'], \Em411\Allegro\Api\Model\ClassifiedPackage::class, 'json', $context));
    ...
    {
        return [\Em411\Allegro\Api\Model\ClassifiedsPackages::class => false];
    }
}

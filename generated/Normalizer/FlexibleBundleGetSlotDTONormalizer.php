...
class FlexibleBundleGetSlotDTONormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    use CheckArray;
    ...
    {
        return \Em411\Allegro\Api\Model\FlexibleBundleGetSlotDTO::class === $type;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return \is_object($data) && \Em411\Allegro\Api\Model\FlexibleBundleGetSlotDTO::class === \get_class($data);
    }
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Em411\Allegro\Api\Model\FlexibleBundleGetSlotDTO();
        ...
        if (\array_key_exists('offers', $data) && null !== $data['offers']) {
            ...
            foreach ($data['offers'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, \Em411\Allegro\Api\Model\FlexibleBundleGetOfferDTO::class, 'json', $context);
            }
    ...
    {
        return [\Em411\Allegro\Api\Model\FlexibleBundleGetSlotDTO::class => false];
    }
}

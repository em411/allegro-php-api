...
class CompensationCodIncreaseOperationNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    use CheckArray;
    ...
    {
        return \Em411\Allegro\Api\Model\CompensationCodIncreaseOperation::class === $type;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return \is_object($data) && \Em411\Allegro\Api\Model\CompensationCodIncreaseOperation::class === \get_class($data);
    }
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Em411\Allegro\Api\Model\CompensationCodIncreaseOperation();
        ...
        if (\array_key_exists('deduction', $data) && null !== $data['deduction']) {
            $object->setDeduction($this->denormalizer->denormalize($data['deduction'], \Em411\Allegro\Api\Model\Deduction::class, 'json', $context));
            unset($data['deduction']);
        } elseif (\array_key_exists('deduction', $data) && null === $data['deduction']) {
            $object->setDeduction(null);
        }
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if ($data->isInitialized('deduction') && null !== $data->getDeduction()) {
            $dataArray['deduction'] = $this->normalizer->normalize($data->getDeduction(), 'json', $context);
        }
        foreach ($data as $key => $value) {
            if (preg_match('/.*/', (string) $key)) {
                $dataArray[$key] = $value;
    ...
    {
        return [\Em411\Allegro\Api\Model\CompensationCodIncreaseOperation::class => false];
    }
}

...
class ProductProposalsResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return \Em411\Allegro\Api\Model\ProductProposalsResponse::class === $type;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return \is_object($data) && \Em411\Allegro\Api\Model\ProductProposalsResponse::class === \get_class($data);
    }
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Em411\Allegro\Api\Model\ProductProposalsResponse();
        ...
        if (\array_key_exists('category', $data) && null !== $data['category']) {
            $object->setCategory($this->denormalizer->denormalize($data['category'], \Em411\Allegro\Api\Model\ProductProposalsResponseCategory::class, 'json', $context));
            unset($data['category']);
        ...
        if (\array_key_exists('parameters', $data) && null !== $data['parameters']) {
            ...
            foreach ($data['parameters'] as $value_1) {
                $values_1[] = $this->denormalizer->denormalize($value_1, \Em411\Allegro\Api\Model\NewProductParameterDto::class, 'json', $context);
            }
        ...
        if (\array_key_exists('publication', $data) && null !== $data['publication']) {
            $object->setPublication($this->denormalizer->denormalize($data['publication'], \Em411\Allegro\Api\Model\ProductProposalsResponsePublication::class, 'json', $context));
    ...
    {
        return [\Em411\Allegro\Api\Model\ProductProposalsResponse::class => false];
    }
}

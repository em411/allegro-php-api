...
class CashOnDeliveryDtoNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    use CheckArray;
    ...
    {
        return \Em411\Allegro\Api\Model\CashOnDeliveryDto::class === $type;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return \is_object($data) && \Em411\Allegro\Api\Model\CashOnDeliveryDto::class === \get_class($data);
    }
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Em411\Allegro\Api\Model\CashOnDeliveryDto();
        ...
        if (\array_key_exists('ownerName', $data) && null !== $data['ownerName']) {
            $object->setOwnerName($data['ownerName']);
            unset($data['ownerName']);
        } elseif (\array_key_exists('ownerName', $data) && null === $data['ownerName']) {
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if ($data->isInitialized('ownerName') && null !== $data->getOwnerName()) {
            $dataArray['ownerName'] = $data->getOwnerName();
        }
    ...
    {
        return [\Em411\Allegro\Api\Model\CashOnDeliveryDto::class => false];
    }
}

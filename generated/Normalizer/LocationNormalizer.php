...
class LocationNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return \Em411\Allegro\Api\Model\Location::class === $type;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return \is_object($data) && \Em411\Allegro\Api\Model\Location::class === \get_class($data);
    }
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Em411\Allegro\Api\Model\Location();
        ...
        if (\array_key_exists('province', $data) && null !== $data['province']) {
            $object->setProvince($data['province']);
            unset($data['province']);
        } elseif (\array_key_exists('province', $data) && null === $data['province']) {
    ...
    {
        return [\Em411\Allegro\Api\Model\Location::class => false];
    }
}

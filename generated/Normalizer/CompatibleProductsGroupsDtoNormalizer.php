...
class CompatibleProductsGroupsDtoNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return \Em411\Allegro\Api\Model\CompatibleProductsGroupsDto::class === $type;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return \is_object($data) && \Em411\Allegro\Api\Model\CompatibleProductsGroupsDto::class === \get_class($data);
    }
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Em411\Allegro\Api\Model\CompatibleProductsGroupsDto();
        ...
        if (\array_key_exists('groups', $data) && null !== $data['groups']) {
            ...
            foreach ($data['groups'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, \Em411\Allegro\Api\Model\CompatibleProductsGroupsDtoGroupsItem::class, 'json', $context);
            }
    ...
    {
        return [\Em411\Allegro\Api\Model\CompatibleProductsGroupsDto::class => false];
    }
}

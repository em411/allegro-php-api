...
class WrapsListingAndCommissionsFeesNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return \Em411\Allegro\Api\Model\WrapsListingAndCommissionsFees::class === $type;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return \is_object($data) && \Em411\Allegro\Api\Model\WrapsListingAndCommissionsFees::class === \get_class($data);
    }
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Em411\Allegro\Api\Model\WrapsListingAndCommissionsFees();
        ...
        if (\array_key_exists('commissions', $data) && null !== $data['commissions']) {
            ...
            foreach ($data['commissions'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, \Em411\Allegro\Api\Model\DescribesSuccessCommissionFee::class, 'json', $context);
            }
        ...
        if (\array_key_exists('quotes', $data) && null !== $data['quotes']) {
            ...
            foreach ($data['quotes'] as $value_1) {
                $values_1[] = $this->denormalizer->denormalize($value_1, \Em411\Allegro\Api\Model\DescribesListingFee::class, 'json', $context);
            }
    ...
    {
        return [\Em411\Allegro\Api\Model\WrapsListingAndCommissionsFees::class => false];
    }
}

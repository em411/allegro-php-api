...
class WarrantyRequestNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return \Em411\Allegro\Api\Model\WarrantyRequest::class === $type;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return \is_object($data) && \Em411\Allegro\Api\Model\WarrantyRequest::class === \get_class($data);
    }
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Em411\Allegro\Api\Model\WarrantyRequest();
        ...
        if (\array_key_exists('attachment', $data) && null !== $data['attachment']) {
            $object->setAttachment($this->denormalizer->denormalize($data['attachment'], \Em411\Allegro\Api\Model\WarrantyAttachment::class, 'json', $context));
    ...
    {
        return [\Em411\Allegro\Api\Model\WarrantyRequest::class => false];
    }
}

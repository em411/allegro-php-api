...
class BadgeApplicationNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    use CheckArray;
    ...
    {
        return \Em411\Allegro\Api\Model\BadgeApplication::class === $type;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return \is_object($data) && \Em411\Allegro\Api\Model\BadgeApplication::class === \get_class($data);
    }
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Em411\Allegro\Api\Model\BadgeApplication();
        ...
        if (\array_key_exists('process', $data) && null !== $data['process']) {
            $object->setProcess($this->denormalizer->denormalize($data['process'], \Em411\Allegro\Api\Model\BadgeApplicationProcess::class, 'json', $context));
            unset($data['process']);
    ...
    {
        return [\Em411\Allegro\Api\Model\BadgeApplication::class => false];
    }
}

...
class RefundIncreaseOperationNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    use CheckArray;
    ...
    {
        return \Em411\Allegro\Api\Model\RefundIncreaseOperation::class === $type;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return \is_object($data) && \Em411\Allegro\Api\Model\RefundIncreaseOperation::class === \get_class($data);
    }
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Em411\Allegro\Api\Model\RefundIncreaseOperation();
        ...
        if (\array_key_exists('participant', $data) && null !== $data['participant']) {
            $object->setParticipant($this->denormalizer->denormalize($data['participant'], \Em411\Allegro\Api\Model\SellerParticipant::class, 'json', $context));
    ...
    {
        return [\Em411\Allegro\Api\Model\RefundIncreaseOperation::class => false];
    }
}

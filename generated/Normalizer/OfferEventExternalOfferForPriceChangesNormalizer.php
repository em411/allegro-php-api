...
class OfferEventExternalOfferForPriceChangesNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    use CheckArray;
    ...
    {
        return \Em411\Allegro\Api\Model\OfferEventExternalOfferForPriceChanges::class === $type;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return \is_object($data) && \Em411\Allegro\Api\Model\OfferEventExternalOfferForPriceChanges::class === \get_class($data);
    }
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Em411\Allegro\Api\Model\OfferEventExternalOfferForPriceChanges();
        ...
        if (\array_key_exists('marketplaces', $data) && null !== $data['marketplaces']) {
            ...
            foreach ($data['marketplaces'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, \Em411\Allegro\Api\Model\OfferMarketplacesPriceChanges::class, 'json', $context);
            }
    ...
    {
        return [\Em411\Allegro\Api\Model\OfferEventExternalOfferForPriceChanges::class => false];
    }
}

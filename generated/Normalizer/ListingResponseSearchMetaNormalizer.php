...
class ListingResponseSearchMetaNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return \Em411\Allegro\Api\Model\ListingResponseSearchMeta::class === $type;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return \is_object($data) && \Em411\Allegro\Api\Model\ListingResponseSearchMeta::class === \get_class($data);
    }
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Em411\Allegro\Api\Model\ListingResponseSearchMeta();
        ...
        if (\array_key_exists('availableCount', $data) && null !== $data['availableCount']) {
            $object->setAvailableCount($data['availableCount']);
            unset($data['availableCount']);
        } elseif (\array_key_exists('availableCount', $data) && null === $data['availableCount']) {
    ...
    {
        return [\Em411\Allegro\Api\Model\ListingResponseSearchMeta::class => false];
    }
}

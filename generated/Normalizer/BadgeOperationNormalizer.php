...
class BadgeOperationNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return \Em411\Allegro\Api\Model\BadgeOperation::class === $type;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return \is_object($data) && \Em411\Allegro\Api\Model\BadgeOperation::class === \get_class($data);
    }
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Em411\Allegro\Api\Model\BadgeOperation();
        ...
        if (\array_key_exists('process', $data) && null !== $data['process']) {
            $object->setProcess($this->denormalizer->denormalize($data['process'], \Em411\Allegro\Api\Model\BadgeOperationProcess::class, 'json', $context));
            unset($data['process']);
    ...
    {
        return [\Em411\Allegro\Api\Model\BadgeOperation::class => false];
    }
}

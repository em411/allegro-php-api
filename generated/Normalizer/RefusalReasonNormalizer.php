...
class RefusalReasonNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return \Em411\Allegro\Api\Model\RefusalReason::class === $type;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return \is_object($data) && \Em411\Allegro\Api\Model\RefusalReason::class === \get_class($data);
    }
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Em411\Allegro\Api\Model\RefusalReason();
        ...
        if (\array_key_exists('relatedReasons', $data) && null !== $data['relatedReasons']) {
            $values_2 = [];
            foreach ($data['relatedReasons'] as $value_2) {
                $values_2[] = $this->denormalizer->denormalize($value_2, \Em411\Allegro\Api\Model\RelatedReason::class, 'json', $context);
            }
            $object->setRelatedReasons($values_2);
            unset($data['relatedReasons']);
        } elseif (\array_key_exists('relatedReasons', $data) && null === $data['relatedReasons']) {
            $object->setRelatedReasons(null);
        }
    ...
    {
        return [\Em411\Allegro\Api\Model\RefusalReason::class => false];
    }
}

...
class SaleProductOfferRequestV1Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return \Em411\Allegro\Api\Model\SaleProductOfferRequestV1::class === $type;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return \is_object($data) && \Em411\Allegro\Api\Model\SaleProductOfferRequestV1::class === \get_class($data);
    }
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Em411\Allegro\Api\Model\SaleProductOfferRequestV1();
        ...
        if (\array_key_exists('productSet', $data) && null !== $data['productSet']) {
            ...
            foreach ($data['productSet'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, \Em411\Allegro\Api\Model\SaleProductOfferRequestV1productSetItem::class, 'json', $context);
            }
        ...
        if (\array_key_exists('compatibilityList', $data) && null !== $data['compatibilityList']) {
            $object->setCompatibilityList($this->denormalizer->denormalize($data['compatibilityList'], \Em411\Allegro\Api\Model\SaleProductOfferRequestV1compatibilityList::class, 'json', $context));
    ...
    {
        return [\Em411\Allegro\Api\Model\SaleProductOfferRequestV1::class => false];
    }
}

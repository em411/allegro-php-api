...
class StringCategoryProductParameterNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    use CheckArray;
    ...
    {
        return \Em411\Allegro\Api\Model\StringCategoryProductParameter::class === $type;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return \is_object($data) && \Em411\Allegro\Api\Model\StringCategoryProductParameter::class === \get_class($data);
    }
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Em411\Allegro\Api\Model\StringCategoryProductParameter();
        ...
        if (\array_key_exists('restrictions', $data) && null !== $data['restrictions']) {
            $object->setRestrictions($this->denormalizer->denormalize($data['restrictions'], \Em411\Allegro\Api\Model\StringCategoryProductParameterrestrictions::class, 'json', $context));
    ...
    {
        return [\Em411\Allegro\Api\Model\StringCategoryProductParameter::class => false];
    }
}

...
class OfferPriceChangeCommandNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    use CheckArray;
    ...
    {
        return \Em411\Allegro\Api\Model\OfferPriceChangeCommand::class === $type;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return \is_object($data) && \Em411\Allegro\Api\Model\OfferPriceChangeCommand::class === \get_class($data);
    }
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Em411\Allegro\Api\Model\OfferPriceChangeCommand();
        if (null === $data || false === \is_array($data)) {
            return $object;
        }
        if (\array_key_exists('modification', $data) && null !== $data['modification']) {
            $object->setModification($this->denormalizer->denormalize($data['modification'], \Em411\Allegro\Api\Model\PriceModification::class, 'json', $context));
    ...
    {
        return [\Em411\Allegro\Api\Model\OfferPriceChangeCommand::class => false];
    }
}

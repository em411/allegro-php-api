...
class AvailablePromotionPackagesNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return \Em411\Allegro\Api\Model\AvailablePromotionPackages::class === $type;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return \is_object($data) && \Em411\Allegro\Api\Model\AvailablePromotionPackages::class === \get_class($data);
    }
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Em411\Allegro\Api\Model\AvailablePromotionPackages();
        ...
        if (\array_key_exists('additionalMarketplaces', $data) && null !== $data['additionalMarketplaces']) {
            ...
            foreach ($data['additionalMarketplaces'] as $value_2) {
                $values_2[] = $this->denormalizer->denormalize($value_2, \Em411\Allegro\Api\Model\MarketplaceAvailablePromotionPackages::class, 'json', $context);
            }
    ...
    {
        return [\Em411\Allegro\Api\Model\AvailablePromotionPackages::class => false];
    }
}

...
class TaskCountNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    use CheckArray;
    ...
    {
        return \Em411\Allegro\Api\Model\TaskCount::class === $type;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return \is_object($data) && \Em411\Allegro\Api\Model\TaskCount::class === \get_class($data);
    }
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Em411\Allegro\Api\Model\TaskCount();
        if (null === $data || false === \is_array($data)) {
            return $object;
        }
        if (\array_key_exists('failed', $data) && null !== $data['failed']) {
            $object->setFailed($data['failed']);
            unset($data['failed']);
        } elseif (\array_key_exists('failed', $data) && null === $data['failed']) {
    ...
    {
        return [\Em411\Allegro\Api\Model\TaskCount::class => false];
    }
}

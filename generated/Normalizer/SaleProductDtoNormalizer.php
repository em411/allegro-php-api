...
class SaleProductDtoNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return \Em411\Allegro\Api\Model\SaleProductDto::class === $type;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return \is_object($data) && \Em411\Allegro\Api\Model\SaleProductDto::class === \get_class($data);
    }
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Em411\Allegro\Api\Model\SaleProductDto();
        ...
        if (\array_key_exists('offerRequirements', $data) && null !== $data['offerRequirements']) {
            $object->setOfferRequirements($this->denormalizer->denormalize($data['offerRequirements'], \Em411\Allegro\Api\Model\OfferRequirements::class, 'json', $context));
            unset($data['offerRequirements']);
        } elseif (\array_key_exists('offerRequirements', $data) && null === $data['offerRequirements']) {
            $object->setOfferRequirements(null);
        }
        if (\array_key_exists('compatibilityList', $data) && null !== $data['compatibilityList']) {
            $object->setCompatibilityList($this->denormalizer->denormalize($data['compatibilityList'], \Em411\Allegro\Api\Model\SaleProductCompatibilityList::class, 'json', $context));
        ...
        if (\array_key_exists('tecdocSpecification', $data) && null !== $data['tecdocSpecification']) {
            $object->setTecdocSpecification($this->denormalizer->denormalize($data['tecdocSpecification'], \Em411\Allegro\Api\Model\TecdocSpecification::class, 'json', $context));
            unset($data['tecdocSpecification']);
        } elseif (\array_key_exists('tecdocSpecification', $data) && null === $data['tecdocSpecification']) {
            $object->setTecdocSpecification(null);
        }
        ...
        if (\array_key_exists('publication', $data) && null !== $data['publication']) {
            $object->setPublication($this->denormalizer->denormalize($data['publication'], \Em411\Allegro\Api\Model\SaleProductDtoPublication::class, 'json', $context));
    ...
    {
        return [\Em411\Allegro\Api\Model\SaleProductDto::class => false];
    }
}

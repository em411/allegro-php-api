...
class SaleProductOfferRequestV1deliveryNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    use CheckArray;
    ...
    {
        return \Em411\Allegro\Api\Model\SaleProductOfferRequestV1delivery::class === $type;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return \is_object($data) && \Em411\Allegro\Api\Model\SaleProductOfferRequestV1delivery::class === \get_class($data);
    }
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Em411\Allegro\Api\Model\SaleProductOfferRequestV1delivery();
        ...
        if (\array_key_exists('shipmentDate', $data) && null !== $data['shipmentDate']) {
            $object->setShipmentDate(\DateTime::createFromFormat('Y-m-d\TH:i:sP', $data['shipmentDate']));
            unset($data['shipmentDate']);
        } elseif (\array_key_exists('shipmentDate', $data) && null === $data['shipmentDate']) {
    ...
    {
        return [\Em411\Allegro\Api\Model\SaleProductOfferRequestV1delivery::class => false];
    }
}

...
class ManualTranslationUpdateRequestNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return \Em411\Allegro\Api\Model\ManualTranslationUpdateRequest::class === $type;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return \is_object($data) && \Em411\Allegro\Api\Model\ManualTranslationUpdateRequest::class === \get_class($data);
    }
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Em411\Allegro\Api\Model\ManualTranslationUpdateRequest();
        if (null === $data || false === \is_array($data)) {
            return $object;
        }
        if (\array_key_exists('description', $data) && null !== $data['description']) {
            $object->setDescription($this->denormalizer->denormalize($data['description'], \Em411\Allegro\Api\Model\ManualDescriptionTranslation::class, 'json', $context));
            unset($data['description']);
        } elseif (\array_key_exists('description', $data) && null === $data['description']) {
            $object->setDescription(null);
        }
        if (\array_key_exists('title', $data) && null !== $data['title']) {
            $object->setTitle($this->denormalizer->denormalize($data['title'], \Em411\Allegro\Api\Model\ManualTitleTranslation::class, 'json', $context));
            unset($data['title']);
        ...
        if (\array_key_exists('safetyInformation', $data) && null !== $data['safetyInformation']) {
            $object->setSafetyInformation($this->denormalizer->denormalize($data['safetyInformation'], \Em411\Allegro\Api\Model\ManualSafetyInformationTranslation::class, 'json', $context));
    ...
    {
        return [\Em411\Allegro\Api\Model\ManualTranslationUpdateRequest::class => false];
    }
}

...
class OfferTranslationUpdatedEventNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return \Em411\Allegro\Api\Model\OfferTranslationUpdatedEvent::class === $type;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return \is_object($data) && \Em411\Allegro\Api\Model\OfferTranslationUpdatedEvent::class === \get_class($data);
    }
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Em411\Allegro\Api\Model\OfferTranslationUpdatedEvent();
        ...
        if (\array_key_exists('translations', $data) && null !== $data['translations']) {
            ...
            foreach ($data['translations'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, \Em411\Allegro\Api\Model\ChangedTranslation::class, 'json', $context);
            }
    ...
    {
        return [\Em411\Allegro\Api\Model\OfferTranslationUpdatedEvent::class => false];
    }
}

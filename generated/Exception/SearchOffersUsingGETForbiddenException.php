...
class SearchOffersUsingGETForbiddenException extends ForbiddenException
{
    /**
    ...
    {
        parent::__construct('The user has no rights to query offers or provided token is invalid.');

...
class UploadOrderInvoiceFileRequestEntityTooLargeException extends RequestEntityTooLargeException
{
    /**
    ...
    {
        parent::__construct('The file is too large. Max file size is 3MB');

...
class GetAllegroPricesOffersBadRequestException extends BadRequestException
{
    /**
    ...
    {
        parent::__construct('Bad request - Invalid request body or missing required fields');

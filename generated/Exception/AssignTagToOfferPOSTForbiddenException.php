...
class AssignTagToOfferPOSTForbiddenException extends ForbiddenException
{
    /**
    ...
    {
        parent::__construct('Forbidden - offer is created by someone else or user is not brandzone user or doesn\'t have tags subscription');

...
class CreateShippingRatesSetUsingPOSTUnprocessableEntityException extends UnprocessableEntityException
{
    /**
    ...
    {
        parent::__construct('The user has reached the limit of shipping rates sets. Information on the limit will be returned in the error message.');

...
class GetCompatibleProductsUnprocessableEntityException extends UnprocessableEntityException
{
    /**
    ...
    {
        parent::__construct('Validation failed - for example invalid format of If-Modified-Since header was passed');

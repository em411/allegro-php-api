...
class ModifyOfferPromoOptionsUsingPOSTUnprocessableEntityException extends UnprocessableEntityException
{
    /**
    ...
    {
        parent::__construct('Offer does not exist or unsupported package name or unsupported change type.');

...
class GetProductChangeProposalForbiddenException extends ForbiddenException
{
    /**
    ...
    {
        parent::__construct('You do not have permission to access change proposal that not belong to you');

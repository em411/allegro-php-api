...
class UploadOrderInvoiceFileUnprocessableEntityException extends UnprocessableEntityException
{
    /**
    ...
    {
        parent::__construct('Uploaded file is empty or order\'s payment is rejected');

...
class ProposeSaleProductConflictException extends ConflictException
{
    /**
    ...
    {
        parent::__construct('Product already exists. Url of the existing product is provided in the HTTP Location header field of the response.');

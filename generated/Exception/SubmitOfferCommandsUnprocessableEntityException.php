...
class SubmitOfferCommandsUnprocessableEntityException extends UnprocessableEntityException
{
    /**
    ...
    {
        parent::__construct('Unprocessable Entity - validation error (e.g., empty offers list, invalid discount declaration, duplicate offers, unsupported marketplace)');

...
class GetPartialProductOfferUnauthorizedException extends UnauthorizedException
{
    /**
    ...
    {
        parent::__construct('Unauthorized - access to this resource requires authorization');

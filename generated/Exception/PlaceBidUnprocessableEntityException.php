...
class PlaceBidUnprocessableEntityException extends UnprocessableEntityException
{
    /**
    ...
    {
        parent::__construct('If bidding was not allowed (see message for explanation).');

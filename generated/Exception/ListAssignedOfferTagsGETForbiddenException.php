...
class ListAssignedOfferTagsGETForbiddenException extends ForbiddenException
{
    /**
    ...
    {
        parent::__construct('User is not brandzone user and doesn\'t have tags subscription');

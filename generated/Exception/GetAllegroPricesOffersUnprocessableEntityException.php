...
class GetAllegroPricesOffersUnprocessableEntityException extends UnprocessableEntityException
{
    /**
    ...
    {
        parent::__construct('Unprocessable entity - Validation error (e.g., invalid marketplace ID, limit out of range, invalid scope)');

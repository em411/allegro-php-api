...
class GetSaleProductNotFoundException extends NotFoundException
{
    /**
    ...
    {
        parent::__construct('A product\'s not found or language version of the product is currently unavailable.');

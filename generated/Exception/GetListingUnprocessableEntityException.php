...
class GetListingUnprocessableEntityException extends UnprocessableEntityException
{
    /**
    ...
    {
        parent::__construct('One of parameters have invalid value or given parameters combination is forbidden.');

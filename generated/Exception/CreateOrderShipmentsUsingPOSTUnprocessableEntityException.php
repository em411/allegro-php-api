...
class CreateOrderShipmentsUsingPOSTUnprocessableEntityException extends UnprocessableEntityException
{
    /**
    ...
    {
        parent::__construct('Some of the provided data is invalid, e.g. line item doesn’t belong to the order');

...
class CreateOrderShipmentsUsingPOSTConflictException extends ConflictException
{
    /**
    ...
    {
        parent::__construct('Maximum waybill usage exceeded (e.g. used in too many orders)');

...
class ExcludeOfferCommandsUnprocessableEntityException extends UnprocessableEntityException
{
    /**
    ...
    {
        parent::__construct('Unprocessable Entity - validation error (e.g., empty offers list, duplicate offers, unsupported marketplace)');

...
class CreateOrderShipmentsUsingPOSTBadRequestException extends BadRequestException
{
    /**
    ...
    {
        parent::__construct('Missing required field or invalid value in the request (e.g. unknown carrier id, carrier name too long, invalid tracking number structure)');

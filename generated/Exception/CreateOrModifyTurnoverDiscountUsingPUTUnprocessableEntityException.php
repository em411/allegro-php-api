...
class CreateOrModifyTurnoverDiscountUsingPUTUnprocessableEntityException extends UnprocessableEntityException
{
    /**
    ...
    {
        parent::__construct('Validation failed – request had correct syntax, but violated validation rules');

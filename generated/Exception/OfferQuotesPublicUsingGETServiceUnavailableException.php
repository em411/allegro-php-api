...
class OfferQuotesPublicUsingGETServiceUnavailableException extends ServiceUnavailableException
{
    /**
    ...
    {
        parent::__construct('Service is currently unavailable. Please try again later.');

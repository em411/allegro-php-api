...
class PatchBadgeConflictException extends ConflictException
{
    /**
    ...
    {
        parent::__construct('Asynchronous badge operation for this offer already exists in status REQUESTED.');

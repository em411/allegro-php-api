...
class GetPromoModificationCommandDetailedResultUsingGETNotFoundException extends NotFoundException
{
    /**
    ...
    {
        parent::__construct('Batch modification command does not exist.');

...
class AddOrderInvoicesMetadataTooManyRequestsException extends TooManyRequestsException
{
    /**
    ...
    {
        parent::__construct('You\'re trying to add another metadata too fast. Upload a file to previously added metadata or wait a few seconds before adding next metadata.');

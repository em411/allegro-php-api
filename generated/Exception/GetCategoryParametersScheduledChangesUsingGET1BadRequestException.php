...
class GetCategoryParametersScheduledChangesUsingGET1BadRequestException extends BadRequestException
{
    /**
    ...
    {
        parent::__construct('Invalid parameters supplied in the request.');

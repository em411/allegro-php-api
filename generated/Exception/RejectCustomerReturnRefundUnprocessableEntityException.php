...
class RejectCustomerReturnRefundUnprocessableEntityException extends UnprocessableEntityException
{
    /**
    ...
    {
        parent::__construct('Unprocessable Entity. Might occur when customer return has already been rejected');

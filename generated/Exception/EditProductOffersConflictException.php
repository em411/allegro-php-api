...
class EditProductOffersConflictException extends ConflictException
{
    /**
    ...
    {
        parent::__construct('Conflict. The current state of the offer does not allow to perform the request (e.g. The previous edition of the offer is still being processed).');

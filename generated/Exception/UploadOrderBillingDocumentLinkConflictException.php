...
class UploadOrderBillingDocumentLinkConflictException extends ConflictException
{
    /**
    ...
    {
        parent::__construct('The given URL to the billing document already exists');

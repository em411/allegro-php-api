...
class CreatePromotionUsingPOST1PreconditionFailedException extends PreconditionFailedException
{
    /**
    ...
    {
        parent::__construct('Validation failed – request had correct syntax, but promotion properties exceeds acceptable limits');

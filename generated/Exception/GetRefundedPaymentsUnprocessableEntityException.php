...
class GetRefundedPaymentsUnprocessableEntityException extends UnprocessableEntityException
{
    /**
    ...
    {
        parent::__construct('Unprocessable Entity. Returned when any of the given search parameters have an invalid value.');

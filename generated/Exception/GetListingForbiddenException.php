...
class GetListingForbiddenException extends ForbiddenException
{
    /**
    ...
    {
        parent::__construct('Access is denied. Application verification required. Read more: <a href="../../listing/" target="_blank">PL</a> / <a href="../../en/listing/" target="_blank">EN</a>');

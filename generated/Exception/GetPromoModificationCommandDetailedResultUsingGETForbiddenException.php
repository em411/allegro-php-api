...
class GetPromoModificationCommandDetailedResultUsingGETForbiddenException extends ForbiddenException
{
    /**
    ...
    {
        parent::__construct('Batch modification command does not belong to seller.');

...
class SubmitOfferCommandsBadRequestException extends BadRequestException
{
    /**
    ...
    {
        parent::__construct('Bad Request - invalid JSON format or missing required fields (e.g., invalid command ID format, null values for offers, offer id, marketplace id, or maxContributionPercentage)');

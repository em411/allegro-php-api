...
class CommandTaskWithStockSubject extends \ArrayObject
{
    /**
     * @var array
     */
     ...
     *
     * @var CommandTaskWithStockSubjectSubject|null
     */
    protected $subject;
    /**
     ...
     * A pair of values which can uniquely identify a modification from the request.
     */
    public function getSubject(): ?CommandTaskWithStockSubjectSubject
    {
        return $this->subject;
    }
     ...
     * A pair of values which can uniquely identify a modification from the request.
     */
    public function setSubject(?CommandTaskWithStockSubjectSubject $subject): self
    {

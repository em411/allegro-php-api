...
class AllegroPricesAccountConsentChangeResponse extends \ArrayObject
{
     ...
     *
     * @var array<string, AllegroPricesAccountConsentChangeResponseAdditionalMarketplacesItem>|null
     */
     ...
     * Consent statuses on marketplaces other than the base marketplace of the account.
     *
     * @return array<string, AllegroPricesAccountConsentChangeResponseAdditionalMarketplacesItem>|null
     */
     ...
     * Consent statuses on marketplaces other than the base marketplace of the account.
     *
     * @param array<string, AllegroPricesAccountConsentChangeResponseAdditionalMarketplacesItem>|null $additionalMarketplaces
     */

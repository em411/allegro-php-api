...
class GetPublicationReportUsingGET extends \Em411\Allegro\Api\Runtime\Client\BaseEndpoint implements \Em411\Allegro\Api\Runtime\Client\Endpoint
{
     ...
     *
     * @throws \Em411\Allegro\Api\Exception\GetPublicationReportUsingGETUnauthorizedException
     * @throws \Em411\Allegro\Api\Exception\GetPublicationReportUsingGETForbiddenException
     * @throws \Em411\Allegro\Api\Exception\GetPublicationReportUsingGETNotFoundException
     */
    protected function transformResponseBody(\Psr\Http\Message\ResponseInterface $response, \Symfony\Component\Serializer\SerializerInterface $serializer, ?string $contentType = null)
    {
        ...
        if (401 === $status) {
            throw new \Em411\Allegro\Api\Exception\GetPublicationReportUsingGETUnauthorizedException($response);
        }
        if (403 === $status) {
            throw new \Em411\Allegro\Api\Exception\GetPublicationReportUsingGETForbiddenException($response);
        }
        if (404 === $status) {
            throw new \Em411\Allegro\Api\Exception\GetPublicationReportUsingGETNotFoundException($response);
        }
    }
}

...
class GetTasksUsingGET extends \Em411\Allegro\Api\Runtime\Client\BaseEndpoint implements \Em411\Allegro\Api\Runtime\Client\Endpoint
{
     ...
     *
     * @throws \Em411\Allegro\Api\Exception\GetTasksUsingGETUnauthorizedException
     * @throws \Em411\Allegro\Api\Exception\GetTasksUsingGETForbiddenException
     * @throws \Em411\Allegro\Api\Exception\GetTasksUsingGETNotFoundException
     * @throws \Em411\Allegro\Api\Exception\GetTasksUsingGETUnprocessableEntityException
     */
    protected function transformResponseBody(\Psr\Http\Message\ResponseInterface $response, \Symfony\Component\Serializer\SerializerInterface $serializer, ?string $contentType = null)
    {
        ...
        if (401 === $status) {
            throw new \Em411\Allegro\Api\Exception\GetTasksUsingGETUnauthorizedException($response);
        }
        if (403 === $status) {
            throw new \Em411\Allegro\Api\Exception\GetTasksUsingGETForbiddenException($response);
        }
        if (404 === $status) {
            throw new \Em411\Allegro\Api\Exception\GetTasksUsingGETNotFoundException($response);
        }
        if (422 === $status) {
            throw new \Em411\Allegro\Api\Exception\GetTasksUsingGETUnprocessableEntityException($response);
        }
    }
}

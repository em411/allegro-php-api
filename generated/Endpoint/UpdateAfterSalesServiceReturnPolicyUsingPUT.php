...
class UpdateAfterSalesServiceReturnPolicyUsingPUT extends \Em411\Allegro\Api\Runtime\Client\BaseEndpoint implements \Em411\Allegro\Api\Runtime\Client\Endpoint
{
     ...
     *             }
     */
    public function __construct(string $returnPolicyId, ?\Em411\Allegro\Api\Model\ReturnPolicyUpdateRequestV1 $requestBody = null, array $headerParameters = [])
    {
    ...
    {
        if ($this->body instanceof \Em411\Allegro\Api\Model\ReturnPolicyUpdateRequestV1) {

...
class DownloadAttachmentGET extends \Em411\Allegro\Api\Runtime\Client\BaseEndpoint implements \Em411\Allegro\Api\Runtime\Client\Endpoint
{
    ...
    /**
     * @throws \Em411\Allegro\Api\Exception\DownloadAttachmentGETUnauthorizedException
     * @throws \Em411\Allegro\Api\Exception\DownloadAttachmentGETNotFoundException
     */
    protected function transformResponseBody(\Psr\Http\Message\ResponseInterface $response, \Symfony\Component\Serializer\SerializerInterface $serializer, ?string $contentType = null)
    {
        ...
        if (401 === $status) {
            throw new \Em411\Allegro\Api\Exception\DownloadAttachmentGETUnauthorizedException($response);
        }
        if (404 === $status) {
            throw new \Em411\Allegro\Api\Exception\DownloadAttachmentGETNotFoundException($response);
        }
    }
}

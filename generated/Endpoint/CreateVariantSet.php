...
class CreateVariantSet extends \Em411\Allegro\Api\Runtime\Client\BaseEndpoint implements \Em411\Allegro\Api\Runtime\Client\Endpoint
{
     ...
     *             }
     */
    public function __construct(?\Em411\Allegro\Api\Model\VariantSet $requestBody = null, array $headerParameters = [])
    {
     ...
     *
     * @throws \Em411\Allegro\Api\Exception\CreateVariantSetUnauthorizedException
     * @throws \Em411\Allegro\Api\Exception\CreateVariantSetForbiddenException
     * @throws \Em411\Allegro\Api\Exception\CreateVariantSetUnprocessableEntityException
     */
    protected function transformResponseBody(\Psr\Http\Message\ResponseInterface $response, \Symfony\Component\Serializer\SerializerInterface $serializer, ?string $contentType = null)
    {
        ...
        if (401 === $status) {
            throw new \Em411\Allegro\Api\Exception\CreateVariantSetUnauthorizedException($response);
        }
        if (403 === $status) {
            throw new \Em411\Allegro\Api\Exception\CreateVariantSetForbiddenException($response);
        }
        if (422 === $status) {
            throw new \Em411\Allegro\Api\Exception\CreateVariantSetUnprocessableEntityException($response);
        }
    }
}

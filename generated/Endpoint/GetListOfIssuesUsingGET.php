...
class GetListOfIssuesUsingGET extends \Em411\Allegro\Api\Runtime\Client\BaseEndpoint implements \Em411\Allegro\Api\Runtime\Client\Endpoint
{
    ...
    /**
     * @return \Em411\Allegro\Api\Model\PostPurchaseIssueListResponse|null
     *
     * @throws \Em411\Allegro\Api\Exception\GetListOfIssuesUsingGETUnauthorizedException
     * @throws \Em411\Allegro\Api\Exception\GetListOfIssuesUsingGETNotFoundException
     * @throws \Em411\Allegro\Api\Exception\GetListOfIssuesUsingGETUnprocessableEntityException
     */
    protected function transformResponseBody(\Psr\Http\Message\ResponseInterface $response, \Symfony\Component\Serializer\SerializerInterface $serializer, ?string $contentType = null)
    {
        ...
        if ((null === $contentType) === false && (200 === $status && false !== mb_strpos(strtolower($contentType), 'application/vnd.allegro.beta.v1+json'))) {
            return $serializer->deserialize($body, 'Em411\Allegro\Api\Model\PostPurchaseIssueListResponse', 'json');
        }
        if (401 === $status) {
            throw new \Em411\Allegro\Api\Exception\GetListOfIssuesUsingGETUnauthorizedException($response);
        }
        if (404 === $status) {
            throw new \Em411\Allegro\Api\Exception\GetListOfIssuesUsingGETNotFoundException($response);
        }
        if (422 === $status) {
            throw new \Em411\Allegro\Api\Exception\GetListOfIssuesUsingGETUnprocessableEntityException($response);
        }
    }
}

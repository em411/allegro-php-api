...
class CreateAnIssueAttachmentUsingPOST extends \Em411\Allegro\Api\Runtime\Client\BaseEndpoint implements \Em411\Allegro\Api\Runtime\Client\Endpoint
{
    ...
    {
        return '/sale/issues/attachments';
    }
     ...
     * @throws \Em411\Allegro\Api\Exception\CreateAnIssueAttachmentUsingPOSTUnprocessableEntityException
     */
    protected function transformResponseBody(\Psr\Http\Message\ResponseInterface $response, \Symfony\Component\Serializer\SerializerInterface $serializer, ?string $contentType = null)
    {
        ...
        if (403 === $status) {
            throw new \Em411\Allegro\Api\Exception\CreateAnIssueAttachmentUsingPOSTForbiddenException($response);
        }
        if (422 === $status) {
            throw new \Em411\Allegro\Api\Exception\CreateAnIssueAttachmentUsingPOSTUnprocessableEntityException($response);
        }
    }
}

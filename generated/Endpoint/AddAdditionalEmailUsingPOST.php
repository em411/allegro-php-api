...
class AddAdditionalEmailUsingPOST extends \Em411\Allegro\Api\Runtime\Client\BaseEndpoint implements \Em411\Allegro\Api\Runtime\Client\Endpoint
{
     ...
     */
    public function __construct(?\Em411\Allegro\Api\Model\AdditionalEmailRequest $requestBody = null, array $headerParameters = [], array $accept = [])
    {
    ...
    {
        if ($this->body instanceof \Em411\Allegro\Api\Model\AdditionalEmailRequest) {
    ...
    /**
     * @return \Em411\Allegro\Api\Model\AdditionalEmail|null
     */
    protected function transformResponseBody(\Psr\Http\Message\ResponseInterface $response, \Symfony\Component\Serializer\SerializerInterface $serializer, ?string $contentType = null)
    {
        ...
        if ((null === $contentType) === false && (201 === $status && false !== mb_strpos(strtolower($contentType), 'application/vnd.allegro.public.v1+json'))) {
            return $serializer->deserialize($body, 'Em411\Allegro\Api\Model\AdditionalEmail', 'json');
        }
        if (400 === $status) {
        }
        if (401 === $status) {

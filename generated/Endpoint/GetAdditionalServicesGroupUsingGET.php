...
class GetAdditionalServicesGroupUsingGET extends \Em411\Allegro\Api\Runtime\Client\BaseEndpoint implements \Em411\Allegro\Api\Runtime\Client\Endpoint
{
     ...
     *             }
     */
    public function __construct(string $groupId, array $headerParameters = [])
    {
     ...
     *
     * @throws \Em411\Allegro\Api\Exception\GetAdditionalServicesGroupUsingGETUnauthorizedException
     * @throws \Em411\Allegro\Api\Exception\GetAdditionalServicesGroupUsingGETNotFoundException
     */
    protected function transformResponseBody(\Psr\Http\Message\ResponseInterface $response, \Symfony\Component\Serializer\SerializerInterface $serializer, ?string $contentType = null)
    {
        ...
        if (401 === $status) {
            throw new \Em411\Allegro\Api\Exception\GetAdditionalServicesGroupUsingGETUnauthorizedException($response);
        }
        if (404 === $status) {
            throw new \Em411\Allegro\Api\Exception\GetAdditionalServicesGroupUsingGETNotFoundException($response);
        }
    }
}

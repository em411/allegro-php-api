...
class GetExcludeOfferCommandStatus extends \Em411\Allegro\Api\Runtime\Client\BaseEndpoint implements \Em411\Allegro\Api\Runtime\Client\Endpoint
{
    ...
    {
        return str_replace(['{commandId}'], [$this->commandId], '/sale/allegro-prices/offers/exclusion-commands/{commandId}');
    }
    ...
    /**
     * @return \Em411\Allegro\Api\Model\SubsidyExcludeOffersCommandPreview|null
     *
     * @throws \Em411\Allegro\Api\Exception\GetExcludeOfferCommandStatusBadRequestException
     * @throws \Em411\Allegro\Api\Exception\GetExcludeOfferCommandStatusUnauthorizedException
     * @throws \Em411\Allegro\Api\Exception\GetExcludeOfferCommandStatusNotFoundException
     */
    protected function transformResponseBody(\Psr\Http\Message\ResponseInterface $response, \Symfony\Component\Serializer\SerializerInterface $serializer, ?string $contentType = null)
    {
        ...
        if ((null === $contentType) === false && (200 === $status && false !== mb_strpos(strtolower($contentType), 'application/vnd.allegro.public.v1+json'))) {
            return $serializer->deserialize($body, 'Em411\Allegro\Api\Model\SubsidyExcludeOffersCommandPreview', 'json');
        }
        if ((null === $contentType) === false && (400 === $status && false !== mb_strpos(strtolower($contentType), 'application/vnd.allegro.public.v1+json'))) {
            throw new \Em411\Allegro\Api\Exception\GetExcludeOfferCommandStatusBadRequestException($serializer->deserialize($body, 'Em411\Allegro\Api\Model\ErrorsHolder', 'json'), $response);
        }

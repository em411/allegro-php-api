...
class GetQuantityModificationCommandStatusUsingGET extends \Em411\Allegro\Api\Runtime\Client\BaseEndpoint implements \Em411\Allegro\Api\Runtime\Client\Endpoint
{
     ...
     *
     * @throws \Em411\Allegro\Api\Exception\GetQuantityModificationCommandStatusUsingGETUnauthorizedException
     * @throws \Em411\Allegro\Api\Exception\GetQuantityModificationCommandStatusUsingGETNotFoundException
     */
    protected function transformResponseBody(\Psr\Http\Message\ResponseInterface $response, \Symfony\Component\Serializer\SerializerInterface $serializer, ?string $contentType = null)
    {
        ...
        if (401 === $status) {
            throw new \Em411\Allegro\Api\Exception\GetQuantityModificationCommandStatusUsingGETUnauthorizedException($response);
        }
        if (404 === $status) {
            throw new \Em411\Allegro\Api\Exception\GetQuantityModificationCommandStatusUsingGETNotFoundException($response);
        }
    }
}

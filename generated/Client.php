...
class Client extends Runtime\Client\Client
{
     ...
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     *
     * @return Model\VariantSets|\Psr\Http\Message\ResponseInterface|null
     *
     * @throws Exception\GetVariantSetsUnauthorizedException
     * @throws Exception\GetVariantSetsForbiddenException
     */
    public function getVariantSets(array $queryParameters = [], array $headerParameters = [], string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new Endpoint\GetVariantSets($queryParameters, $headerParameters), $fetch);
    }
     ...
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     *
     * @return Model\VariantSetResponse|\Psr\Http\Message\ResponseInterface|null
     *
     * @throws Exception\CreateVariantSetUnauthorizedException
     * @throws Exception\CreateVariantSetForbiddenException
     * @throws Exception\CreateVariantSetUnprocessableEntityException
     */
    public function createVariantSet(?Model\VariantSet $requestBody = null, array $headerParameters = [], string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new Endpoint\CreateVariantSet($requestBody, $headerParameters), $fetch);
    }
     ...
     * @return \Psr\Http\Message\ResponseInterface|null
     *
     * @throws Exception\DeleteVariantSetUnauthorizedException
     * @throws Exception\DeleteVariantSetForbiddenException
     * @throws Exception\DeleteVariantSetNotFoundException
     */
    public function deleteVariantSet(string $setId, array $headerParameters = [], string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new Endpoint\DeleteVariantSet($setId, $headerParameters), $fetch);
    }
     ...
     * @return Model\VariantSetResponse|\Psr\Http\Message\ResponseInterface|null
     *
     * @throws Exception\GetVariantSetUnauthorizedException
     * @throws Exception\GetVariantSetForbiddenException
     * @throws Exception\GetVariantSetNotFoundException
     */
    public function getVariantSet(string $setId, array $headerParameters = [], string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new Endpoint\GetVariantSet($setId, $headerParameters), $fetch);
    }
     ...
     * @return Model\VariantSetResponse|\Psr\Http\Message\ResponseInterface|null
     *
     * @throws Exception\UpdateVariantSetUnauthorizedException
     * @throws Exception\UpdateVariantSetForbiddenException
     * @throws Exception\UpdateVariantSetUnprocessableEntityException
     */
    public function updateVariantSet(string $setId, ?Model\VariantSet $requestBody = null, array $headerParameters = [], string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new Endpoint\UpdateVariantSet($setId, $requestBody, $headerParameters), $fetch);
    }
     ...
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     *
     * @return Model\ListingResponse|\Psr\Http\Message\ResponseInterface|null
     *
     * @throws Exception\GetListingBadRequestException
     * @throws Exception\GetListingForbiddenException
     * @throws Exception\GetListingNotFoundException
     * @throws Exception\GetListingNotAcceptableException
     * @throws Exception\GetListingUnprocessableEntityException
     * @throws Exception\GetListingTooManyRequestsException
     * @throws Exception\GetListingInternalServerErrorException
     * @throws Exception\GetListingBadGatewayException
     */
    public function getListing(array $queryParameters = [], array $headerParameters = [], string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new Endpoint\GetListing($queryParameters, $headerParameters), $fetch);
    }
